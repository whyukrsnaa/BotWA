...
const connectKeWA = () => {
const semar = makeWASocket({logger:pino({level:'silent'}),printQRInTerminal: true,auth: state,browser: ["KrisnaBotz", "Safari", "1.0"]})
...
msg = denz.messages[0]
nomorOwner = ['6287784550689']
nomorDeveloper = ['6287784550689']
